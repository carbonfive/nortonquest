...
exports.default = function () {
  ...
  return app.use((0, _compression2.default)()).use('/stylesheets', _express2.default.static('./lib/stylesheets')).use(_bodyParser2.default.urlencoded({ extended: false })).use((0, _expressSession2.default)({
    ...
    var layarUserId = request.session.layarUserId;
    var _request$body = request.body;
    var room = _request$body.room;
    var whiteMove0 = _request$body.whiteMove0;
    var blackMove = _request$body.blackMove;
    var whiteMove1 = _request$body.whiteMove1;

    _teams2.default.addLayarUser(layarUserId, { room: room, whiteMove0: whiteMove0, blackMove: blackMove, whiteMove1: whiteMove1 }).then(function (team) {
    ...
    _teams2.default.forLayarUser(layarUserId).then(function (team) {
      json.hotspots = locations().map(function (location) {
        return {
